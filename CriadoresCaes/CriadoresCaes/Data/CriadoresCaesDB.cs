   ...
   public class CriadoresCaesDB : DbContext {
      ...
      protected override void OnModelCreating(ModelBuilder modelBuilder) {
         ...
         modelBuilder.Entity<Caes>().HasData(
            new Caes { Id = 1, Nome = "Aguia da Quinta do Conde", Sexo = "F", DataNascimento = new DateTime(2019, 4, 16), LOP = "LOP446793", RacaFK = 1 },
            new Caes { Id = 2, Nome = "Aileen da Quinta do Lordy", Sexo = "F", DataNascimento = new DateTime(2019, 10, 10), LOP = "LOP446795", RacaFK = 1 },
            new Caes { Id = 3, Nome = "Aladim do Canto do Bairro Pimenta", Sexo = "F", DataNascimento = new DateTime(2011, 3, 22), LOP = "LOP446801", RacaFK = 5 },
            new Caes { Id = 4, Nome = "Albert do Canto do Bairro Pimenta", Sexo = "F", DataNascimento = new DateTime(2008, 6, 8), LOP = "LOP446804", RacaFK = 5 },
            new Caes { Id = 5, Nome = "Alabaster da Casa do Sobreiral", Sexo = "F", DataNascimento = new DateTime(2012, 8, 21), LOP = "LOP446807", RacaFK = 2 },
            new Caes { Id = 6, Nome = "Gannett do Quintal de Cima", Sexo = "F", DataNascimento = new DateTime(2010, 10, 1), LOP = "LOP446809", RacaFK = 6 },
            new Caes { Id = 7, Nome = "Gardenia da Tapada de Cima", Sexo = "F", DataNascimento = new DateTime(2010, 12, 11), LOP = "LOP446811", RacaFK = 3 },
            new Caes { Id = 8, Nome = "Forte da Flecha do Indio", Sexo = "F", DataNascimento = new DateTime(2013, 4, 22), LOP = "LOP446799", RacaFK = 7 },
            new Caes { Id = 9, Nome = "Garbo da Flecha do Indio", Sexo = "M", DataNascimento = new DateTime(2011, 5, 10), LOP = "LOP446812", RacaFK = 7 },
            new Caes { Id = 10, Nome = "Garfunkle da Quinta do Lordy", Sexo = "F", DataNascimento = new DateTime(2017, 3, 21), LOP = "LOP446814", RacaFK = 4 },
            new Caes { Id = 11, Nome = "Garnet do Quintal de Cima", Sexo = "M", DataNascimento = new DateTime(2018, 1, 4), LOP = "LOP446816", RacaFK = 8 }
         );
         ...
         modelBuilder.Entity<CriadorCaes>().HasData(
            new CriadorCaes { Id = 1, DataCompra = new DateTime(2019, 6, 15), CaoFK = 1, CriadorFK = 1 },
            new CriadorCaes { Id = 2, DataCompra = new DateTime(2019, 12, 9), CaoFK = 2, CriadorFK = 2 },
            new CriadorCaes { Id = 3, DataCompra = new DateTime(2011, 5, 21), CaoFK = 3, CriadorFK = 4 },
            new CriadorCaes { Id = 4, DataCompra = new DateTime(2008, 8, 7), CaoFK = 4, CriadorFK = 5 },
            new CriadorCaes { Id = 5, DataCompra = new DateTime(2012, 10, 20), CaoFK = 5, CriadorFK = 6 },
            new CriadorCaes { Id = 6, DataCompra = new DateTime(2010, 11, 30), CaoFK = 6, CriadorFK = 7 },
            new CriadorCaes { Id = 7, DataCompra = new DateTime(2011, 2, 9), CaoFK = 7, CriadorFK = 8 },
            new CriadorCaes { Id = 8, DataCompra = new DateTime(2013, 6, 21), CaoFK = 8, CriadorFK = 9 },
            new CriadorCaes { Id = 9, DataCompra = new DateTime(2011, 7, 9), CaoFK = 9, CriadorFK = 10 },
            new CriadorCaes { Id = 10, DataCompra = new DateTime(2017, 5, 20), CaoFK = 10, CriadorFK = 5 },
            new CriadorCaes { Id = 11, DataCompra = new DateTime(2018, 3, 5), CaoFK = 11, CriadorFK = 8 }
         );
